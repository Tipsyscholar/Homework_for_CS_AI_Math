...
> 🌟 2025.11.12 MIT6.S184完结撒花(3次Lab)<br>
...
| 课程/领域 | 课程名称/主题 | 来源 | 核心技术栈/目标 |
| :--- | :--- | :--- | :--- |
|  |高等概率论|ZJU|无穷可分, 中心极限, 大数定律, 鞅极限|
| **MIT 6.S184 & MIT 6.S987** | 深度生成模型| MIT | SDEs, 扩散模型 (Diffusion Models), Score-Matching |
| | 随机分析 | PKU | 随机过程, 鞅表示, SDEs, 随机积分, 应用随机最优控制|
| | 高维概率 | Roman Vershynin |链, 随机矩阵, 稀疏恢复, Dvoretzky–Milman 定理 |
|  | 大数据算法 | PKU & Deep-ML | 机器学习, 应用统计, 大规模算法, 优化算法, 随机算法, 近似算法, 最优传输|
| **Paper Reading** | 论文阅读与复现 | | [Paper Reading List](https://github.com/Tipsyscholar/Homework_for_ai-cs-math/blob/main/Paper_reading.md) |