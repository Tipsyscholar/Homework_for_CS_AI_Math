...
def floor_div(args):
    ...
    if args.rest is nil :
        return args.first
    args.first=args.first//calc_eval(args.rest.first)
...
def eval_and(expressions):
    ...
    if expressions.rest is nil:
        if expressions.first =="and":
            return True
        elif expressions.first =="False":
            return False
        else :
            return calc_eval(expressions.first) or calc_eval(expressions.first) is not False
    return (calc_eval(expressions.first) or calc_eval(expressions.first) is not False) and eval_and(expressions.rest) 
